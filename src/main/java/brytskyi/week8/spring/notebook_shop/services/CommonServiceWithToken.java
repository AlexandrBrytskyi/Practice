...
public class CommonServiceWithToken implements ICommonServiceWithToken {
    ...
    public CommonServiceWithToken() {
    }

    public CommonServiceWithToken(Loginable loginService, IAdminService adminService, ISellerService sellerService, IBuyerService buyerService, IGetProductionService service) {
    ...
    private UserType defineUserType(String token) throws NullTokenException, NotRegisteredTokenException {
        ...
        UserType type = tokensContext.getTokens().get(token);
